...
from src.preprocessing import get_data_from_txt, read_data
from src.data import get_mean_media_interval, get_maximal_silence_period, get_basic_infos, percentage_msg_with_emoji, get_mean_message_len, get_moving_average_nb_message, get_questions_by_name, get_number_of_message
from src.viz import plot_wordcloud, plot_monthly_data, plot_daily_data, plot_percentage_msg_emoji, plot_emoji_data, plot_hourly_data, plot_messages_per_day, plot_moving_nb_messages_individuals, plot_moving_nb_messages
...
# How to upload conversation to analyze
...
####### removed a tabulation from here ################
data = read_data("./data",
                 "Discussion WhatsApp avec Confinement doss .txt",
                 header,
                 date_format)
